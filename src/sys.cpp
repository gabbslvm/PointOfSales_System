                  ...
                  double subtotal, double discountAmt, double taxAmt, double finalTotal)
{
    ...
    if (q1 > 0) cout << "Javascript (Javachip) x" << q1 << " = " << q1 * p1 << "\n";
    if (q2 > 0) cout << "C#appuccino (Capuccino) x" << q2 << " = " << q2 * p2 << "\n";
    if (q3 > 0) cout << "Cout Latte (Caramel) x" << q3 << " = " << q3 * p3 << "\n";
    if (q4 > 0) cout << "C-trawberry Latte x" << q4 << " = " << q4 * p4 << "\n";
    if (q5 > 0) cout << "Double Dark Roast x" << q5 << " = " << q5 * p5 << "\n";
    if (q6 > 0) cout << "Compilepresso (Espresso) x" << q6 << " = " << q6 * p6 << "\n";
    if (q7 > 0) cout << "JavaBeans Brownies x" << q7 << " = " << q7 * p7 << "\n";
    if (q8 > 0) cout << "Blueberry Py x" << q8 << " = " << q8 * p8 << "\n";
    if (q9 > 0) cout << "Peach Mango Py x" << q9 << " = " << q9 * p9 << "\n";
    if (q10 > 0) cout << "Apple Py x" << q10 << " = " << q10 * p10 << "\n";
    if (q11 > 0) cout << "Byte-sized Cookie x" << q11 << " = " << q11 * p11 << "\n";
    if (q12 > 0) cout << "RAM-en Noodles x" << q12 << " = " << q12 * p12 << "\n";
    ...
    do {
        ...
        if (userType == 1) {
            ...
            while (attempts < 3) {
                cout << "Enter Password: ";
                cin >> entered;
                if (entered == correctPassword) { passOK = true; system("clear"); break; }
                else { attempts++; cout << "Wrong password. Attempts left: " << (3 - attempts) << "\n"; }
            } 
            ...
            if (passOK == false) {
                ...
                while (empLoop == 1) {
                    ...
                    switch (choice) {
                        case 1: {
                            int add;
                            cout << "Add to Javascript (Javachip): "; cin >> add; stock_javachip += add;
                            cout << "Add to C#appuccino: "; cin >> add; stock_capuccino += add;
                            cout << "Add to Cout Latte: "; cin >> add; stock_latte += add;
                            cout << "Add to C-trawberry Latte: "; cin >> add; stock_strawberry += add;
                            cout << "Add to Double Dark Roast: "; cin >> add; stock_darkroast += add;
                            cout << "Add to Compilepresso: "; cin >> add; stock_espresso += add;
                            cout << "Add to Brownies: "; cin >> add; stock_brownies += add;
                            cout << "Add to Blueberry Py: "; cin >> add; stock_blueberry += add;
                            cout << "Add to Peach Mango Py: "; cin >> add; stock_peach += add;
                            cout << "Add to Apple Py: "; cin >> add; stock_apple += add;
                            cout << "Add to Cookie: "; cin >> add; stock_cookie += add;
                            cout << "Add to RAM-en Noodles: "; cin >> add; stock_ramen += add;
                            break;
                        }
                        case 2:
                            cout << "\n--- Current Inventory ---\n";
                        ...
                        case 3: {
                            int ns;
                            cout << "Set new stock for Javachip: "; cin >> ns; stock_javachip = ns;
                            cout << "Set new stock for Capuccino: "; cin >> ns; stock_capuccino = ns;
                            cout << "Set new stock for Latte: "; cin >> ns; stock_latte = ns;
                            cout << "Set new stock for Strawberry Latte: "; cin >> ns; stock_strawberry = ns;
                            cout << "Set new stock for Dark Roast: "; cin >> ns; stock_darkroast = ns;
                            cout << "Set new stock for Espresso: "; cin >> ns; stock_espresso = ns;
                            cout << "Set new stock for Brownies: "; cin >> ns; stock_brownies = ns;
                            cout << "Set new stock for Blueberry Py: "; cin >> ns; stock_blueberry = ns;
                            cout << "Set new stock for Peach Mango Py: "; cin >> ns; stock_peach = ns;
                            cout << "Set new stock for Apple Py: "; cin >> ns; stock_apple = ns;
                            cout << "Set new stock for Cookie: "; cin >> ns; stock_cookie = ns;
                            cout << "Set new stock for Ramen: "; cin >> ns; stock_ramen = ns;
                            break;
                        }
                        case 4:
            ...
            while (ordering == 1) {
                ...
                if (menuChoice >= 1 && menuChoice <= 12) {
                    ...
                    if (qty <= 0) {
                        ...
                        switch(menuChoice) {
                            case 1: if (qty<=stock_javachip){ stock_javachip-=qty; oq1+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 2: if (qty<=stock_capuccino){ stock_capuccino-=qty; oq2+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 3: if (qty<=stock_latte){ stock_latte-=qty; oq3+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 4: if (qty<=stock_strawberry){ stock_strawberry-=qty; oq4+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 5: if (qty<=stock_darkroast){ stock_darkroast-=qty; oq5+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 6: if (qty<=stock_espresso){ stock_espresso-=qty; oq6+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 7: if (qty<=stock_brownies){ stock_brownies-=qty; oq7+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 8: if (qty<=stock_blueberry){ stock_blueberry-=qty; oq8+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 9: if (qty<=stock_peach){ stock_peach-=qty; oq9+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 10: if (qty<=stock_apple){ stock_apple-=qty; oq10+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 11: if (qty<=stock_cookie){ stock_cookie-=qty; oq11+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                            case 12: if (qty<=stock_ramen){ stock_ramen-=qty; oq12+=qty; cout << "Added.\n";} else cout<<"Not enough.\n"; break;
                        }
                    }
